<form role="search" method="get" class="search-form flex" action="<?php echo esc_url(home_url('/')); ?>">
    <div class="flex w-full max-w-md mx-auto">
        ...
        <button 
            type="submit" 
            class="px-6 py-2 bg-primary text-white rounded-r-lg hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors"
        >
